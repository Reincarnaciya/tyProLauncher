...
public class ManagerStart {
    ...
    private String linuxStartStr() {
        return Main.getRuntimeDir() + File.separator + "jre8" + File.separator + "bin" + File.separator + "java -Xss1M -Djava.library.path=" + pathToVersion
                ...
                + "libraries" + File.separator + "org" + File.separator + "ow2" + File.separator + "asm" + File.separator + "asm-tree" + File.separator + "9.1" + File.separator + "asm-tree-9.1.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "ow2" + File.separator + "asm" + File.separator + "asm-util" + File.separator + "9.1" + File.separator + "asm-util-9.1.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "ow2" + File.separator + "asm" + File.separator + "asm-analysis" + File.separator + "9.1" + File.separator + "asm-analysis-9.1.jar:" + pathToVersion
                + "libraries" + File.separator + "cpw" + File.separator + "mods" + File.separator + "modlauncher" + File.separator + "8.1.3" + File.separator + "modlauncher-8.1.3.jar:" + pathToVersion
                + "libraries" + File.separator + "cpw" + File.separator + "mods" + File.separator + "grossjava9hacks" + File.separator + "1.3.3" + File.separator + "grossjava9hacks-1.3.3.jar:" + pathToVersion
                + "libraries" + File.separator + "net" + File.separator + "minecraftforge" + File.separator + "accesstransformers" + File.separator + "3.0.1" + File.separator + "accesstransformers-3.0.1.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "antlr" + File.separator + "antlr4-runtime" + File.separator + "4.9.1" + File.separator + "antlr4-runtime-4.9.1.jar:" + pathToVersion
                + "libraries" + File.separator + "net" + File.separator + "minecraftforge" + File.separator + "eventbus" + File.separator + "4.0.0" + File.separator + "eventbus-4.0.0.jar:" + pathToVersion
                + "libraries" + File.separator + "net" + File.separator + "minecraftforge" + File.separator + "forgespi" + File.separator + "3.2.0" + File.separator + "forgespi-3.2.0.jar:" + pathToVersion
                + "libraries" + File.separator + "net" + File.separator + "minecraftforge" + File.separator + "coremods" + File.separator + "4.0.6" + File.separator + "coremods-4.0.6.jar:" + pathToVersion
                + "libraries" + File.separator + "net" + File.separator + "minecraftforge" + File.separator + "unsafe" + File.separator + "0.2.0" + File.separator + "unsafe-0.2.0.jar:" + pathToVersion
                + "libraries" + File.separator + "com" + File.separator + "electronwill" + File.separator + "night-config" + File.separator + "core" + File.separator + "3.6.3" + File.separator + "core-3.6.3.jar:" + pathToVersion
                + "libraries" + File.separator + "com" + File.separator + "electronwill" + File.separator + "night-config" + File.separator + "toml" + File.separator + "3.6.3" + File.separator + "toml-3.6.3.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "jline" + File.separator + "jline" + File.separator + "3.12.1" + File.separator + "jline-3.12.1.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "apache" + File.separator + "maven" + File.separator + "maven-artifact" + File.separator + "3.6.3" + File.separator + "maven-artifact-3.6.3.jar:" + pathToVersion
                + "libraries" + File.separator + "net" + File.separator + "jodah" + File.separator + "typetools" + File.separator + "0.8.3" + File.separator + "typetools-0.8.3.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "apache" + File.separator + "logging" + File.separator + "log4j" + File.separator + "log4j-api" + File.separator + "2.15.0" + File.separator + "log4j-api-2.15.0.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "apache" + File.separator + "logging" + File.separator + "log4j" + File.separator + "log4j-core" + File.separator + "2.15.0" + File.separator + "log4j-core-2.15.0.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "apache" + File.separator + "logging" + File.separator + "log4j" + File.separator + "log4j-slf4j18-impl" + File.separator + "2.15.0" + File.separator + "log4j-slf4j18-impl-2.15.0.jar:" + pathToVersion
                + "libraries" + File.separator + "net" + File.separator + "minecrell" + File.separator + "terminalconsoleappender" + File.separator + "1.2.0" + File.separator + "terminalconsoleappender-1.2.0.jar:" + pathToVersion
                ...
                + "libraries" + File.separator + "com" + File.separator + "ibm" + File.separator + "icu" + File.separator + "icu4j" + File.separator + "66.1" + File.separator + "icu4j-66.1.jar:" + pathToVersion
                + "libraries" + File.separator + "com" + File.separator + "mojang" + File.separator + "javabridge" + File.separator + "1.0.22" + File.separator + "javabridge-1.0.22.jar:" + pathToVersion
                + "libraries" + File.separator + "net" + File.separator + "sf" + File.separator + "jopt-simple" + File.separator + "jopt-simple" + File.separator + "5.0.3" + File.separator + "jopt-simple-5.0.3.jar:" + pathToVersion
                + "libraries" + File.separator + "io" + File.separator + "netty" + File.separator + "netty-all" + File.separator + "4.1.25.Final" + File.separator + "netty-all-4.1.25.Final.jar:" + pathToVersion
                + "libraries" + File.separator + "com" + File.separator + "google" + File.separator + "guava" + File.separator + "guava" + File.separator + "21.0" + File.separator + "guava-21.0.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "apache" + File.separator + "commons" + File.separator + "commons-lang3" + File.separator + "3.5" + File.separator + "commons-lang3-3.5.jar:" + pathToVersion
                + "libraries" + File.separator + "commons-io" + File.separator + "commons-io" + File.separator + "2.5" + File.separator + "commons-io-2.5.jar:" + pathToVersion
                + "libraries" + File.separator + "commons-codec" + File.separator + "commons-codec" + File.separator + "1.10" + File.separator + "commons-codec-1.10.jar:" + pathToVersion
                + "libraries" + File.separator + "net" + File.separator + "java" + File.separator + "jinput" + File.separator + "jinput" + File.separator + "2.0.5" + File.separator + "jinput-2.0.5.jar:" + pathToVersion
                + "libraries" + File.separator + "net" + File.separator + "java" + File.separator + "jutils" + File.separator + "jutils" + File.separator + "1.0.0" + File.separator + "jutils-1.0.0.jar:" + pathToVersion
                ...
                + "libraries" + File.separator + "org" + File.separator + "apache" + File.separator + "httpcomponents" + File.separator + "httpcore" + File.separator + "4.3.2" + File.separator + "httpcore-4.3.2.jar:" + pathToVersion
                + "libraries" + File.separator + "it" + File.separator + "unimi" + File.separator + "dsi" + File.separator + "fastutil" + File.separator + "8.2.1" + File.separator + "fastutil-8.2.1.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "apache" + File.separator + "logging" + File.separator + "log4j" + File.separator + "log4j-api" + File.separator + "2.8.1" + File.separator + "log4j-api-2.8.1.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "apache" + File.separator + "logging" + File.separator + "log4j" + File.separator + "log4j-core" + File.separator + "2.8.1" + File.separator + "log4j-core-2.8.1.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "lwjgl" + File.separator + "lwjgl" + File.separator + "3.2.2" + File.separator + "lwjgl-3.2.2.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "lwjgl" + File.separator + "lwjgl-jemalloc" + File.separator + "3.2.2" + File.separator + "lwjgl-jemalloc-3.2.2.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "lwjgl" + File.separator + "lwjgl-openal" + File.separator + "3.2.2" + File.separator + "lwjgl-openal-3.2.2.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "lwjgl" + File.separator + "lwjgl-opengl" + File.separator + "3.2.2" + File.separator + "lwjgl-opengl-3.2.2.jar:" + pathToVersion
                + "libraries" + File.separator + "org" + File.separator + "lwjgl" + File.separator + "lwjgl-glfw" + File.separator + "3.2.2" + File.separator + "lwjgl-glfw-3.2.2.jar:" + pathToVersion
                ...
                pathToVersion + "assets" + File.separator + "log_configs" + File.separator + "client-1.12.xml cpw.mods.modlauncher.Launcher " +
                "--username " + user.GetLogin() + " " +
                "--version Forge 1.16.5 " +
                "--gameDir " + pathToVersion +
                "--assetsDir " + pathToVersion + File.separator + "assets --assetIndex 1.16 " +
                "--uuid " + this.UUID + " " +
                "--accessToken " + this.accessToken + " " +
                "--userType mojang " +
                "--versionType modified" +
