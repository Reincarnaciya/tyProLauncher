...
public class ManagerStart {
    ...
    public static void StartMinecraft(String version) {
        ...
        String autoConnect = "";
        if(Settings.isAutoConnect()) autoConnect = "--server ip29.ip-146-59-75.eu --port 25574";
        ...
        JsonObject hashes;
        try {
            JsonObject requestObject = (JsonObject) JsonParser.parseString(hashStart.getFullAnswer());
        ...
        String finalAutoConnect = autoConnect;
        String pathToVersion = Main.getClientDir().toString() + File.separator + version;
        new Thread(() -> {
            try {
                ...
                try {
                    ...
                    if(UserPC._os.contains("linux") || UserPC._os.contains("unix")){
                        ...
                        p1 = runtime.exec(
                                pathToVersion + "\\runtime\\jre-legacy\\windows\\jre-legacy\\bin\\javaw.exe"
